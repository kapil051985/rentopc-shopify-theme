  ...
  customElements.define(
    ...
    class QuickAddModal extends ModalDialog {
      ...
      preprocessHTML(productElement) {
        ...
        this.cleanViewDetailsLinks(productElement);
      ...
      cleanViewDetailsLinks(productElement) {
        productElement.querySelectorAll('.product__view-details').forEach((link) => {
          const sanitizedLabel = link.textContent.replace(/\uFFFD/g, '').split('<svg')[0].trim();
          link.textContent = sanitizedLabel;
          link.classList.remove('animate-arrow');
        });
      }
